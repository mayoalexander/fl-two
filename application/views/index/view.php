...
<body>
	<div class="preloader">
		<img src="http://freelabel.net/landing/view/content/img/loader.gif" alt="Preloader image">
	</div>
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="<?php echo $site['logo']; ?>" data-active-url="<?php echo $site['logo']; ?>" alt="" width="80px"></a>
			</div>
			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right main-nav">
					<li><a href="#intro"><?php echo $post[0]['twitter']; ?></a></li>
					<li><a href="#services">Related</a></li>
					<li><a href="#team">Promotions</a></li>
