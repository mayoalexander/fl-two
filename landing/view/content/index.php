...
<head>
    ...
    <title><?php echo $post[0]['twitter']; ?> - <?php echo $post[0]['blogtitle']; ?> | <?php echo $site['name']; ?></title>
	...
	<!-- Normalize -->
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP; ?>landing/view/content/css/normalize.css">
	<!-- Bootstrap -->
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP; ?>landing/view/content/css/bootstrap.css">
	<!-- Owl -->
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP; ?>landing/view/content/css/owl.css">
	<!-- Animate.css -->
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP; ?>landing/view/content/css/animate.css">
	<!-- Font Awesome -->
	<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/content/fonts/font-awesome-4.1.0/css/font-awesome.min.css">
	<!-- Elegant Icons -->
	<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/content/fonts/eleganticons/et-icons.css">
	<!-- Main style -->
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP; ?>landing/view/content/css/cardio.css">
	<style type="text/css">
		header {
			background-image: url('<?php echo $post[0]["photo"]; ?>');
		}
	</style>
</head>
...
<body>
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="<?php echo $site['logo']; ?>" data-active-url="<?php echo $site['logo']; ?>" alt=""></a>
			</div>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white"><?php echo $post[0]['twitter']; ?></h3>
							<h1 class="white typed"><?php echo $post[0]['blogtitle']; ?></h1>
			...
			<div class="row intro-tables">
				<div class="col-md-4">
					<div class="intro-table intro-table-first">
						<h5 class="white heading"><?php echo $post[0]['twitter']; ?>'s Schedule</h5>
				...
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						<h5 class="white heading hide-hover">Follow <?php echo $post[0]['twitter']; ?></h5>
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular">Register Today</h4>
							<h4 class="white heading small-pt">20% Discount</h4>
							<a href="http://freelabel.net/users/login/register/" class="btn btn-white-fill expand">Register</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
	...
	<!-- Scripts -->
	<script src="<?php echo HTTP; ?>landing/view/content/js/jquery-1.11.1.min.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/owl.carousel.min.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/bootstrap.min.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/wow.min.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/typewriter.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/jquery.onepagenav.js"></script>
	<script src="<?php echo HTTP; ?>landing/view/content/js/main.js"></script>
</body>
