...
'.$twitpic;
			...
			<p id="post_'.$post_id.'" class="mag-view-buttons" style="display:block;">
				<!--<span class="btn btn-warning" target="_blank" >'.$page_views.'</span>-->
				...
				<!--<a class="btn btn-social btn-default btn-facebook" target="_blank" href="#'.$rand_id.'">
