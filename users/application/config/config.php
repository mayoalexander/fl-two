 ...
 */
define('URL', 'http://freelabel.net/users/');
...
define('FACEBOOK_LOGIN_APP_ID', '450514531818920');
define('FACEBOOK_LOGIN_APP_SECRET', 'cdeade6e64ce119be25b4fd6c3e59109');
...
define('COOKIE_DOMAIN', '.freelabel.net');
 ...
 */
define('DB_TYPE', 'mysql');
define('DB_HOST', 'hugee.db.13071759.hostedresource.com');
define('DB_NAME', 'hugee');
define('DB_USER', 'hugee');
define('DB_PASS', 'Treytonmayo2010!');
...
// name of your host
define("EMAIL_SMTP_HOST", 'smtpout.secureserver.net');
// leave this true until your SMTP can be used without login
define("EMAIL_SMTP_AUTH", true);
// SMTP provider username
define("EMAIL_SMTP_USERNAME", 'admin@freelabel.net');
// SMTP provider password
define("EMAIL_SMTP_PASSWORD", 'Simplicity93!');
// SMTP provider port
define("EMAIL_SMTP_PORT", 465);
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@freelabel.net");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "FREELABEL");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset!");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@freelabel.net");
define("EMAIL_VERIFICATION_FROM_NAME", "FREELABEL");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for FREELABEL");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
 ...
 */
// $loginWithFacebook_URL = 'https://www.facebook.com/dialog/oauth?client_id=450514531818920&redirect_uri=http%3A%2F%2Ffreelabel.net%2Fusers%2Flogin%2FloginWithFacebook&state=61ec9b1ffab19ffd4afe1536739912fe&sdk=php-sdk-3.2.3';
// $loginWithFacebook_URL = $this->getFacebookLoginUrl();
...
define("FEEDBACK_FACEBOOK_UID_ALREADY_EXISTS", "Sorry, but you have already registered! <a href='http://freelabel.net/users/login/index' >Click Here to Login</a><br> "); //<a class='btn btn-facebook' href='".$loginWithFacebook_URL."'><i class='fa fa-facebook' ></i> Logging in with Facebook..</a>
