...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img src="<?php echo $site['user']['profile-photo'];?>" style="width:40px;" alt="<?php echo $site['user']['name'];?>"/><span><?php echo $site['user']['name'];?></span></div>
					<div class="icon-list">
