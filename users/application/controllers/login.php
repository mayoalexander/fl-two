...
class Login extends Controller
{
    ...
    function delete_file($file_id)
    {
        ...
        if ($result = mysqli_query($con,$sql)){
            ...
            echo 'Oops, the file was not deleted! Something went wrong!!';
        }
        //echo 'so here we are.';
    }
    ...
    function delete_promo($file_id)
    {
        ...
        $result = mysqli_query($con,$sql);
        if ($result = mysqli_query($con,$sql)){
            echo 'Promo Successfully Deleted!';
        } else {
            echo 'Oops, the promo was not deleted! Something went wrong!!';
        }
        //echo 'so here we are.';
    }
    ...
    function delete_feed($file_id)
    {
        ...
        if ($result = mysqli_query($con,$sql)){
            ...
            echo 'Oops, the feed was not deleted! Something went wrong!!';
        }
        //echo 'so here we are.';
    }
